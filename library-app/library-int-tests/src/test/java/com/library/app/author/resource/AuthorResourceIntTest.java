...
public class AuthorResourceIntTest {
	...
	public void findByFilterPaginatingAndOrderingDescendingByName() {
		...
		// first page
		Response response = resourceClient.resourcePath(PATH_RESOURCE + "?page=0&perPage=10&sort=-name").get();
		...
		// second page
		response = resourceClient.resourcePath(PATH_RESOURCE + "?page=1&perPage=10&sort=-name").get();
		assertThat(response.getStatus(), is(equalTo(HttpCode.OK.getCode())));
